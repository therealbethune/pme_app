...
def to_jsonable(obj: Any) -> Any:
    ...
    # Fallback: convert to string
        ...
        warnings.warn(f"Converting {type(obj)} to string for JSON serialization", UserWarning)
        return str(obj)
...
def _array_to_jsonable(arr: np.ndarray) -> Union[List[Any], Any]:
...
def _numpy_scalar_to_jsonable(scalar: Union[np.integer, np.floating]) -> Union[int, float, None]:
...
def dataframe_to_records(df: pd.DataFrame, orient: str = 'records') -> List[Dict[str, Any]]:
    """
