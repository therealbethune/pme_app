...
def render_xlsx(df: pd.DataFrame, path: Path) -> None:
    ...
    if not df.empty:
        ...
        key_metrics = [
            ...
            ('Annualized Return', metrics.get('Annualized Return', 0), percentage_format),
    ...
    charts_ws.write('A3', 'Chart functionality can be added here for visual analysis', metric_format)
