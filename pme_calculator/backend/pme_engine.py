...
class PMEEngine:
    ...
    def __init__(self, fund_data: pd.DataFrame, benchmark_data: pd.DataFrame, benchmark_type: BenchmarkType = BenchmarkType.PRICE_ONLY):
    ...
    def __del__(self):
        ...
        try:
            ...
            if hasattr(self, 'benchmark_temp_path') and os.path.exists(self.benchmark_temp_path):
