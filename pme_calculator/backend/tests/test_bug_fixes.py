...
from pme_engine import PMEEngine, BenchmarkType, PMEResult
...
class TestPMEEngine:
    ...
    def create_sample_data(self):
        ...
        fund_data = pd.DataFrame({
            ...
            'nav': [1000, 1050, 1100, 1080, 1120, 1150, 1180, 1160, 1200, 1220, 1250, 0]
        })
    ...
    def test_cleanup_on_deletion(self):
        ...
        fund_temp_exists = hasattr(engine, 'fund_temp_path') and os.path.exists(engine.fund_temp_path)
        benchmark_temp_exists = hasattr(engine, 'benchmark_temp_path') and os.path.exists(engine.benchmark_temp_path)
...
class TestCacheEdgeCases:
    ...
    def test_cache_key_generation_with_special_characters(self):
        ...
        key1 = cache_manager._generate_key("test", "arg with spaces", "arg/with/slashes")
        key2 = cache_manager._generate_key("test", "arg with spaces", "arg/with/slashes")
