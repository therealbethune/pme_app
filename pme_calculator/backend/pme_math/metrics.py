...
def ln_pme(cashflows: pd.Series, index_values: pd.Series, dates: pd.Series) -> Tuple[float, float]:
    """
...
def pme_plus(cashflows: pd.Series, nav_values: pd.Series, 
             index_values: pd.Series, dates: pd.Series) -> Tuple[float, float]:
    """
