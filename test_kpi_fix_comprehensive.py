            ...
            if fund_files and index_files:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        print(f"✅ Analysis completed: {analysis_data.get('success', False)}")
                        ...
                        if response.status_code == 200:
                            ...
                            metrics = data.get('metrics', {})
                            print(f"   Post-analysis IRR: {metrics.get('Fund IRR', 0):.1%}")
                            print(f"   Post-analysis TVPI: {metrics.get('TVPI', 0):.2f}x")
                        else:
                            print(f"❌ Post-analysis metrics summary failed: {response.status_code}")
                    else:
