...
class ErrorEnvelope(Generic[T]):
    ...
    def error_summary(self) -> str:
        ...
        return ", ".join([f"{count} {severity}" for severity, count in error_counts.items()])

def envelope_ok(data: T, 
                metadata: Optional[Dict[str, Any]] = None,
                performance: Optional[PerformanceMetrics] = None) -> ErrorEnvelope[T]:
...
def envelope_partial(data: Optional[T],
...
def envelope_fail(errors: List[ErrorDetail],
                 data: Optional[T] = None,
                 metadata: Optional[Dict[str, Any]] = None,
                 performance: Optional[PerformanceMetrics] = None) -> ErrorEnvelope[T]:
...
class ErrorCollector:
    ...
    def to_envelope(self, data: Optional[T] = None, 
                   metadata: Optional[Dict[str, Any]] = None,
                   performance: Optional[PerformanceMetrics] = None) -> ErrorEnvelope[T]:
...
def create_missing_data_warning(missing_count: int, total_count: int, data_type: str) -> ErrorDetail:
