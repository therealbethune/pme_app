...
from pme_math.error_envelope import envelope_ok, envelope_fail, ErrorCollector, ErrorCategory, ErrorSeverity
...
def test_alignment_engine():
    ...
    print(f"   This would cause: 'boolean index did not match indexed array along axis 0'")
    ...
    try:
        ...
        print(f"✅ Aligned data shapes: Fund={fund_aligned.shape}, Index={index_aligned.shape}")
...
def test_error_envelope():
    ...
    print(f"✅ Error envelope: success={error_envelope.success}, errors={len(error_envelope.errors)}")
...
def test_integration_scenario():
    ...
    print(f"📊 Realistic scenario: Fund={fund_data.shape} (quarterly), Index={index_data.shape} (daily)")
    ...
    try:
        ...
        print(f"   Both datasets now have identical date alignment")
