...
class TestLoadingIssues:
    ...
    def test_backend_imports(self):
        ...
        try:
            ...
            try:
                ...
                assert (
                    engine is not None
                ), "PMEAnalysisEngine should be instantiated successfully"
                assert hasattr(
                    engine, "load_fund_data"
                ), "Engine should have load_fund_data method"
                assert hasattr(
                    engine, "load_index_data"
                ), "Engine should have load_index_data method"
    ...
    def test_frontend_configuration(self):
        ...
        if vite_config.exists():
            ...
            ), "vite.config.ts should have proper export"
    ...
    def test_database_fallback(self):
        ...
        try:
            ...
            assert (
                init_db is not None
            ), "init_db function should be imported successfully"
