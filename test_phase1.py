...
try:
    ...
    fund_data = pd.DataFrame(
        {"date": ["2023-01-01", "2023-02-01"], "cashflow": [-1000, 500]}
    )
    index_data = pd.DataFrame(
        {"date": ["2023-01-01", "2023-01-15", "2023-02-01"], "value": [100, 101, 102]}
    )
    ...
    print(
        f"✅ Alignment successful: Fund={fund_aligned.shape}, Index={index_aligned.shape}"
    )
